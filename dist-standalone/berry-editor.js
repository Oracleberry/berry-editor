...
function __wasm_bindgen_func_elem_206(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_206(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
const MinimapBuilderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_minimapbuilder_free(ptr >>> 0, 1));
...
export class MinimapBuilder {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        MinimapBuilderFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_minimapbuilder_free(ptr, 0);
    }
    /**
    ...
    static create(canvas_id) {
        try {
            ...
            wasm.minimapbuilder_create(retptr, ptr0, len0);
...
if (Symbol.dispose) MinimapBuilder.prototype[Symbol.dispose] = MinimapBuilder.prototype.free;
    ...
    imports.wbg.__wbg_new_ff12d2b041fb48f1 = function(arg0, arg1) {
        try {
            ...
            var cb0 = (arg0, arg1) => {
                ...
                state0.a = 0;
                try {
                    return __wasm_bindgen_func_elem_206(a, state0.b, arg0, arg1);
                } finally {
                    state0.a = a;
                }
            };
