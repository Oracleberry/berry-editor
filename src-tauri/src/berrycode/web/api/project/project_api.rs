    ...
    if let Some(description) = payload.description {
        if !description.trim().is_empty() {
            ...
            let project_type = payload.project_type
                .as_deref()
                .and_then(crate::berrycode::scaffolding::ProjectType::from_str)
                .unwrap_or(crate::berrycode::scaffolding::ProjectType::WebApp);
            ...
            if !api_key.is_empty() {
                match crate::berrycode::scaffolding::generate_project_structure(
                    &description,
                    &payload.name,
                    project_type,
                    &api_key,
